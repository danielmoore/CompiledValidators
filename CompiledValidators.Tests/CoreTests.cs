...
namespace CompiledValidators.Tests
{
    ...
    public class CoreTests
    {
        ...
        public void SetUp()
        {
            _sut = new Validator(true, new AttributeValidatorProvider(), new ValidationExpressionConverter());
        }
        ...
        {
            Assert.AreSame(Validator.RootValidationError, _sut.ValidateToFirstError<object>(null));
        }
        ...
        public void FirstInvalidObjectIsReturned()
        {
            ...
            Assert.AreSame(obj.Value2[0], _sut.ValidateToFirstError(obj).Object);
        }

        [Test]
        public void CorrectlyIdentifiesInvalidMember()
        {
            Assert.AreEqual("root.Value1", _sut.ValidateToFirstError(new PartialValidClass()).Member);
        }
        ...
        public void CorrectlyIdentifiesAllInvalidMembers()
        {
            ...
            var result = _sut.Validate(obj).Select(v => v.Object).ToArray();
